function Product({ product }: any) {
	return (
		<div className="p-4 rounded-md items-center justify-center bg-white w-full mx-auto dark:bg-black">
			<div className="flex-wrap shadow-gray-500 shadow-md p-4 dark:border-white border rounded-lg dark:shadow-none dark:bg-gray-700">
