	...
	return (
		...
		>
			<div className="p-4 rounded-md items-center justify-center bg-white w-full mx-auto dark:bg-blind_market min-h-max h-full">
				<div className="flex-wrap shadow-gray-500 shadow-md p-4 dark:border-black border rounded-lg dark:shadow-none dark:bg-gray-700 h-full items-center justify-center mx-auto">
