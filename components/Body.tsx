...
function Body() {
  ...
  return (
    <div className="w-full relative min-h-screen z-0 bg-white dark:bg-black">
      ...
      <div className="grid p-4 2xl:grid-cols-6 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-4 lg:gap-8 cursor-pointer">
