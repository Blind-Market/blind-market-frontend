			...
			<div className="min-h-full w-full bg-white dark:bg-blind_market">
				...
				<div className="bg-white dark:bg-blind_market mx-10 lg:mx-80 shadow-md rounded-lg p-4">
					...
					<textarea
						id="editor"
						rows={15}
						className="block lg:w-full text-lg text-gray-800 bg-white dark:bg-gray-800 dark:text-white dark:placeholder-gray-400 border-1 my-2 rounded-lg focus:ring-blue-500 focus:border-blue-500"
