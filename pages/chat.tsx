      ...
      {innerWidth > 860 ? (
        ...
        <div className="w-full h-full bg-white dark:bg-blind_market text-center grid grid-flow-col grid-cols-12">
          <div className="left-0 right-auto h-full w-fit col-start-1 col-end-1">
            ...
            <div
              className=" bg-white dark:bg-blind_market w-full h-full justify-center align-middle items-center content-center z-40 border-r-2 border-r-slate-400 dark:border-r-black cursor-pointer"
            ...
            >
              <svg
                ...
                strokeWidth="1.5"
                stroke="currentColor"
                className="w-12 h-12 mx-auto my-auto top-1/2 bottom-auto fixed cursor-pointer"
                onClick={() => setDrawerStatus(!!!drawerStatus)}
                type="button"
              >
                <path
